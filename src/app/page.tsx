          ...
          <div className="gap-2 flex justify-between">
            <div className="flex-col flex flex-1 space-y-1.5">
              <BlurFadeText
                ...
                yOffset={8}
                text={`Hi, ik ben ${DATA.name.split(" ")[0]} 👋`}
              />
              <BlurFadeText
      ...
      <section id="work">
        <div className="flex min-h-0 flex-col gap-y-3">
          <BlurFade delay={BLUR_FADE_DELAY * 5}>
            <h2 className="text-xl font-bold">Werk ervaring</h2>
          </BlurFade>
            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl">
                  Bekijk mijn recente werkt
                </h2>
                <p className="text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  Ik heb aan verschillende projecten gewerkt, van eenvoudige
                  websites tot complexe webapplicaties. Hier zijn een paar van
                  mijn favorieten.
                </p>
              </div>
            </div>
